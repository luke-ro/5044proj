function [xhat_kplus1_minus, P_kplus1_minus] = EKF_dynamicPrediction(xhat_k_plus, P_k_plus, Q, gamma, const, npts_int)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here
    ode_options = odeset('RelTol',1e-12, 'AbsTol',1e-12);
    ode_fun = @(t,X) dynamics(t,X,const,zeros(length(xhat_k_plus),npts_int));
