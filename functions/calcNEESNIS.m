...
semilogy(epsNEESbar,'ro','MarkerSize',6,'LineWidth',2),hold on
% plot(r1x*ones(size(epsNEESbar)),'r--','LineWidth',2)
% plot(r2x*ones(size(epsNEESbar)),'r--','LineWidth',2)
semilogy(r1x*ones(size(epsNEESbar)),'r--','LineWidth',2)
semilogy(r2x*ones(size(epsNEESbar)),'r--','LineWidth',2)
...
semilogy(epsNISbar,'bo','MarkerSize',6,'LineWidth',2),hold on
...
%     plot(r2y*ones(size(epsNISbar)),'b--','LineWidth',2)
    semilogy(r1y*ones(size(epsNISbar)),'b--','LineWidth',2)
    semilogy(r2y*ones(size(epsNISbar)),'b--','LineWidth',2)
end
